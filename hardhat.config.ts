...
function getNetwork(name: string): {
  ...
  return getNetwork1(
    `https://${name}.g.alchemy.com/v2/${process.env.ALCHEMY_API_KEY as string}`
  );
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    sepolia: getNetwork("eth-sepolia"),
    arbitrumSepolia: getNetwork("arb-sepolia"),
    optimismSepolia: getNetwork("opt-sepolia"),
